...
\experienceentry{KLA}{Machine Learning Engineer Intern - \link{run:images/KLA-BBP.pdf}{BBP}}{Python, Image Classification}{Milpitas, CA}{June-Sept 2023}
\begin{resumebullets}
...
\projectentry{run:images/CAPSTONE.pdf}{Health Monitoring Wearable -- Capstone}{Python, C, Java, ASIC Design}{Nov 2023-June 2024}
\begin{resumebullets}
...
{\sectionstyle Languages:} Python, SQL, C++, C\\
{\sectionstyle ML \& Data:} PyTorch, TensorFlow, ClickHouse, DuckDB\\
{\sectionstyle Infrastructure:} Kubernetes, Kafka, AWS (MSK, S3, CloudWatch), Docker, FastAPI, Git\\
{\sectionstyle AI tooling:} MCP, MLX\\
\begin{tabularx}{\linewidth}{@{}Yr@{}}
